class Underscore(object):
	...
	# find
	# determine whether a value exists within a list a values
	...
	# filter
	# looks through the values in a list returning an array of all the values that meet a specific condition
	...
	# reject
	# lookes through the values in a list returning an array of all the values that do not meet a specific condition
